  ...
  <body style="background: linear-gradient(120deg,green, orangered);">
    <div class="center">
      ...
      <form method="post" action="signin.php" >
        ...
        <input type="submit" value="Go Back"onclick="back()" style="margin-bottom:5px; linear-gradient(120deg,green, orangered);">
        <input type="submit" value="Login"  style="background: linear-gradient(120deg,green, orangered);">
